        ...
        return s.html`
            <style>
                ...
                tm-button{
                    ...
                    --focus-color: #000;
                    --background-image: url("./assets/Button_record.svg");
                    width: 220px;
                    height: 50px;
                }
                ...
                #sample-reset-button{
                  ...
                  --active-background-color: #174EA6;
                  --focus-color: #000;
                  --background-image: url("./assets/Button_soft_reset.svg");
                  width: 50px;
                  height: 50px;
                }
                ...
                <div id="webcam-container">
                    ...
                    <div id="show-record" style=${
                      this.showRecord ? "" : "display: none;"
                        ...
                        <tm-button 
                            id='sample-reset-button'                                                 
                            @click=${(t) => {                              
                              globalTmInstanceHack.samples.pop();
                              globalTmInstanceHack.model.examples[globalTmInstanceHack.samples.length] = [];                              
                              globalTmInstanceHack.requestUpdate();
                            }}>
                            Reset
                        </tm-button>
                        ...
                        <div id="hold-to-record-settings" class=${
                          this.holdToRecord ? "disabled" : ""
                            ...
                            <div class="setting-option">
                                ...
                                <div class="input-holder">
                                    <input id="delay" type="number" min="0" value=${
                                      this.recordDelay / 1e3
                                    }
                                        @change=${(t) => {
                                          this.recordDelay =
                            ...
                            <div class="setting-option">
                                ...
                                <div class="input-holder">
                                    <input id="duration" type="number" min="0" value=${
                                      this.recordDuration / 1e3
                                    }
                                        @change=${(t) => {
                                          this.recordDuration =
                                            1e3 * Number(t.target.value);
        ...
        return o.html`
            <style>
                ...
                tm-button{
                    ...
                    width: 100%;
                    --background-color: transparent;
                    --background-image: url("./assets/Button_training.svg");
                }
            </style>
                  ...
                  (n = (function (t) {
                    ...
                    if (2 === t.version)
                      return (
                        ...
                        [
                          "./teachable-machine-models/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_" +
                            t.alpha.toFixed(2) +
                            "_" +
                            e.IMAGE_SIZE +
                            "_no_top/model.json",
    ...
    let d = class extends i.LitElement {
      constructor() {
        super(...arguments),
          ...
          (this.training = {
            ...
            description: i.html`<p style='font-size:22px'>Super, ihr habt genug Bilder gemacht. Jetzt könnt ihr die KI trainieren. Dafür einfach auf „Training“ klicken und ein paar Sekunden warten!</p><p style='font-size:22px'>Sobald das Training abgeschlossen ist, weiter!</p>`,
          }),
          (this.introduction = {
      ...
      renderClassifierCard(t) {
        ...
        (this.backButton.disabled = !1),
          (this.canProgress = () =>
            this.samples &&
            this.samples[t] &&
            this.samples[t].length >= Math.max(e[t].minimum || 0, 200));
        const n = ((t, e) => {
            ...
            <div id="left-content">
                <div id="sample-input-container" class="flex-column">
                    ...
                    <div id="train-button-container">
                        <tm-progress-button id="train-button" value="0" label="Training"
                            @click=${() => {
                              if(!trainClicked){
                                trainClicked = true;
                                return o(this, void 0, void 0, function* () {                                
                                ...
                                console.warn('Train already clicked!');
                              }
      ...
      renderRunCard() {
        ...
        return i.html`
            ...
            <div id="right-content">
                <h2 class="top-drop">NICE!</h2>
                <p style='font-size:22px'>
                  Darf ich vorstellen: Eure eigene KI, die Verkehrsschilder erkennen kann!
                </p>
                <p style='font-size:22px'>
                  WICHTIG: Dieses Fenster bitte nicht schließen!
                </p>
                <p style='font-weight:700;font-size:22px'>
                  Wie es weitergeht, erfahrt ihr auf dem Tablet.
                </p>
            </div>
        `;
      }
      ...
      render() {
        return i.html`
            <style>
                ...
                */
                ...
                #custom-next-button {
                  ...
                  width: 400px;
                  height: 200px;
                  background-image: url("./assets/Button_weiter.svg");
                  background-size: contain;
                  background-repeat: no-repeat;
                ...
                #custom-next-button[data-label="Done"] {
                  display: none
                }
                ...
                #custom-reset-button {
                  ...
                  background-color: transparent;
                  border: none;
                  background-image: url("./assets/Button_reset.svg");
                  background-size: contain;
                  background-repeat: no-repeat;
                  transition: all 0.1s eas-in-out 0s;
                }
            ...
            <div id="lightbox">&nbsp;</div>
            <button id="custom-reset-button" @click=${() =>
          ...
          this.stepIndex > 0 && (this.stepIndex--, this.requestUpdate());
                    ...
                    <div id="next">
                        <button id="custom-next-button" ?disabled=${!this.canProgress()} data-label=${
          0 === this.stepIndex
            ? "Start"
        ...
        return o.html`
            <style>
                :host {
                    ...
                    /* padding: 20px 40px; */
                    background-color: white;
                    background-image: url("./assets/Background_wizard.png");
