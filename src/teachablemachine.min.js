        ...
        `}getPart(){const t=[()=>this.renderIntroCard()];for(let e=0;e<this.classes.length;e++)t.push(()=>this.renderClassifierCard(e));return t.push(this.renderTrainCard,this.renderRunCard),t[this.stepIndex]()}render(){return i.html`
            ...
            <ta-card>
                ...
                <div id="navigation" slot="navigation">
                    ...
                    <div id="next">
                        <tm-button ?disabled=${!this.canProgress()} label=${0===this.stepIndex?"Start":this.stepIndex+1<this.totalSteps?"Next":"Done"} @click=${()=>{this.stepIndex+1<this.totalSteps?(this.stepIndex++,console.log("request update stepIndex",this.stepIndex),this.requestUpdate()):location.reload()}}></tm-button>
                    </div>
            </ta-card>
